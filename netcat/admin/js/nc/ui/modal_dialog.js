...
//                        '<div class="nc-modal-dialog-header-tabs"><ul><li></li></ul></div>' +
        ...
        when_ready_to_open: function() {
            $.modal(this.dialog_container, {
                ...
                closeHTML: this.has_header ? '<a class="modalCloseImg" title="' + ncLang.Close + '"></a>' : '',
        ...
        resize: function() {
            ...
            var $window = $(window.top.window),
                custom_width = this.dialog_container.data('width'),
                custom_height = this.dialog_container.data('height'),
                w = custom_width  || ($window.width()  - 100 * 2),
                h = custom_height || ($window.height() - 100 * 2),
                o = this.options;
            ...
            $('#simplemodal-container').css({
                ...
                top: (custom_height ? ($window.height() - custom_height) / 2 : 100) + 'px'
