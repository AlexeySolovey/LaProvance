...
do {
    ...
    if ($admin_mode) {
        ...
        if ($nc_core->get_settings('AutosaveUse') == 1) {
            $f_AdminButtons_version = $SUB_FOLDER . $HTTP_ROOT_PATH . "message.php?isVersion=1&restore=1&catalogue=" . $catalogue . "&sub=" . $sub . "&cc=" . $cc . "&message=" . $f_RowID . "&curPos=" . $curPos;
